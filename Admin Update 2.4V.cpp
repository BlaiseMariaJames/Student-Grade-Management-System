...
void table_creation_function(sqlite3 *db){
    ...
    rc = sqlite3_exec(db, sql, create_insert_table, 0, 0);
    sql = strdup("INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('CSE1','CS'); \ INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('CSE2','CS'); \
	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('CSE3','CS'); \ 	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('CSM1','AI'); \
	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('CSN1','CN'); \	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('CSO1','IN'); \
	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('IT1','IT');  \	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('IT2','IT');  \
	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('ECE1','EC'); \	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('ECE2','EC'); \
	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('ECE3','EC'); \	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('EEE1','EE'); \
	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('EEE2','EE'); \	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('ECI1','CI'); \
	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('CIV1','CE'); \	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('CIV2','CE'); \
	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('MEC1','ME'); \	INSERT INTO SECTION (SECTIONID,DEPTNO) VALUES ('MEC2','ME');");
    rc = sqlite3_exec(db, sql, create_insert_table, 0, 0);
}
